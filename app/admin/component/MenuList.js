            ...
            <div className="bg-white rounded-xl shadow-sm p-4 mb-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="text-right text-sm text-amber-600">
                  ...
                  {filteredMenus.length > 1 ? "menus found" : "menu found"}
                </div>
              </div>
            </div>
                        ...
                        >
                          <div className="p-4">
                            ...
                            <table className="w-full">
                              ...
                              <tbody>
                                <tr className=" border-t-[1px] border-amber-200 text-center ">
                                  <td className="text-center text-[15px] py-2">1</td>
                                  <td className="text-center text-[15px] py-2">
                                    menuItem name
                                  </td>
                                  <td className="text-center text-[15px] py-2">
                                    menuItem price
                                  ...
                                  <td className="flex justify-center py-2">
                                    <button className="flex items-center  text-sm space-x-1 text-white bg-red-600/50 hover:text-red-800 px-2 py-[2px] rounded-lg hover:bg-red-50 transition-colors">
                                      <Trash2 size={12} />
                                      <span>Delete</span>
                                    </button>
                                  </td>
                                ...
                                <tr className=" border-t-[1px] border-amber-200 text-center py-2">
                                  <td className="text-center text-[15px]">2</td>
                            ...
                            <div className="flex justify-end space-x-2 pt-3 border-t border-amber-100 py-2">
                              ...
                              <button className="flex items-center space-x-1 text-sky-600 hover:text-amber-800 p-2 rounded hover:bg-amber-100 transition-colors">
                                <Pencil size={16} />
                                <span>Edit</span>
                              </button>
                              <button
